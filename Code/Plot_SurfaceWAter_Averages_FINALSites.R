...
my_F$siteID<-ordered(my_F$siteID, levels=c("MAYF", 'COMO' , 'MART', "HOPB" , 'TOMB' ,'BLWA', 'POSE', 'WALK' , 'CUPE', 'GUIL', 'ARIK', 'KING', 'BLUE'))
...
my_Br$siteID<-ordered(my_Br$siteID, levels=c("MAYF", 'COMO' , 'MART', "HOPB" , 'TOMB' ,'BLWA', 'POSE', 'WALK' , 'CUPE', 'GUIL', 'ARIK', 'KING', 'BLUE'))
